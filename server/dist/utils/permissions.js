...
(function (Permission) {
    // Board permissions
    Permission["VIEW_BOARD"] = "VIEW_BOARD";
    Permission["EDIT_BOARD"] = "EDIT_BOARD";
    Permission["DELETE_BOARD"] = "DELETE_BOARD";
    Permission["MANAGE_MEMBERS"] = "MANAGE_MEMBERS";
    // List permissions
    Permission["CREATE_LIST"] = "CREATE_LIST";
    Permission["EDIT_LIST"] = "EDIT_LIST";
    Permission["DELETE_LIST"] = "DELETE_LIST";
    Permission["REORDER_LISTS"] = "REORDER_LISTS";
    // Card permissions
    Permission["CREATE_CARD"] = "CREATE_CARD";
    Permission["EDIT_CARD"] = "EDIT_CARD";
    Permission["DELETE_CARD"] = "DELETE_CARD";
    Permission["MOVE_CARD"] = "MOVE_CARD";
    // Card content permissions
    Permission["EDIT_CARD_DETAILS"] = "EDIT_CARD_DETAILS";
    Permission["EDIT_CARD_DESCRIPTION"] = "EDIT_CARD_DESCRIPTION";
    Permission["EDIT_CARD_DUE_DATE"] = "EDIT_CARD_DUE_DATE";
    Permission["MANAGE_CARD_LABELS"] = "MANAGE_CARD_LABELS";
    Permission["MANAGE_CARD_ATTACHMENTS"] = "MANAGE_CARD_ATTACHMENTS";
    Permission["MANAGE_CARD_COMMENTS"] = "MANAGE_CARD_COMMENTS";
    Permission["MANAGE_CARD_CHECKLISTS"] = "MANAGE_CARD_CHECKLISTS";
    // Checklist permissions
    Permission["COMPLETE_CHECKLIST_ITEM"] = "COMPLETE_CHECKLIST_ITEM";
    Permission["EDIT_CHECKLIST_ITEM"] = "EDIT_CHECKLIST_ITEM";
    Permission["DELETE_CHECKLIST_ITEM"] = "DELETE_CHECKLIST_ITEM";
    Permission["CREATE_CHECKLIST_ITEM"] = "CREATE_CHECKLIST_ITEM";
    // Comment permissions
    Permission["CREATE_COMMENT"] = "CREATE_COMMENT";
    Permission["EDIT_COMMENT"] = "EDIT_COMMENT";
    Permission["DELETE_COMMENT"] = "DELETE_COMMENT";
...
function hasPermission(userRole, permission, isBoardOwner = false) {
...
function canPerformAction(userRole, action, isBoardOwner = false) {
